...
"""autogenerated by genpy from arduino_bot_test/AddTwoIntsRequest.msg. Do not edit."""
import codecs
import sys
...
class AddTwoIntsRequest(genpy.Message):
  ...
  _type = "arduino_bot_test/AddTwoIntsRequest"
...
def _get_struct_2q():
    ...
    return _struct_2q
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from arduino_bot_test/AddTwoIntsResponse.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
...
class AddTwoIntsResponse(genpy.Message):
  ...
  _type = "arduino_bot_test/AddTwoIntsResponse"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """#Response
int64 sum
...
class AddTwoInts(object):
  _type          = 'arduino_bot_test/AddTwoInts'
