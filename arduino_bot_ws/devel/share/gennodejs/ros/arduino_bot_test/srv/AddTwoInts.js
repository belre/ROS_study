...
// (in-package arduino_bot_test.srv)
...
class AddTwoIntsRequest {
  ...
  static datatype() {
    ...
    return 'arduino_bot_test/AddTwoIntsRequest';
  }
...
class AddTwoIntsResponse {
  ...
  static datatype() {
    // Returns string type for a service object
    return 'arduino_bot_test/AddTwoIntsResponse';
  }
...
module.exports = {
  ...
  datatype() { return 'arduino_bot_test/AddTwoInts'; }
};
